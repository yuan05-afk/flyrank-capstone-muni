...
export const PERSONA_CARDS: PersonaCard[] = [
  ...
  },
  {
    ...
    body: "Recruiters can ask about Yuan's college program at FEU, Dean's and President's Lister standing, preferred Capstone stack, programming languages, data tools, Backend AI craft, FlyRank internship Capstones, the personal project CheckMyDevice, the CS0035 course project ShopScript, ACM and JPCS involvement, Copilot and NAIPDC training, and Code Wars team leadership. For private contact details not in the knowledge base, leave a note in chat or use GitHub.",
