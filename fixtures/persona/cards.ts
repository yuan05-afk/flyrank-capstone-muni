...
export const PERSONA_CARDS: PersonaCard[] = [
  {
    kind: "bio",
    title: "About Yuan",
    body: "Yuan is a FlyRankAI intern building Capstone products across Backend AI Engineering and General AI Fluency. Yuan ships grounded AI systems with clear demos, honest evals, and polished product surfaces. Recently Yuan has shipped Capstone work including Lens, Broadcast, and Muni.",
  ...
  },
  {
    ...
    body: "Lens is a Capstone project Yuan shipped that tags images, ranks them by meaning, and refuses wrong pairings with a mismatch guard. It proves fox posts reject wolf images and reports top-1 precision.",
  ...
  },
  {
    ...
    body: "Broadcast is a Capstone project Yuan shipped: a campaign studio that generates platform-aware captions and image variants with durable jobs and review desks.",
  ...
  },
  {
    ...
    body: "Muni is Yuan's General AI Fluency Impact Project Capstone: a personal brand site plus a grounded agent that cites verified knowledge and refuses when evidence is missing. Yuan shipped Muni as a public Capstone product.",
