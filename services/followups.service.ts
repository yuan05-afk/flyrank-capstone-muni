...
const TOPIC_GRAPH: TopicNode[] = [
  ...
  },
  {
    ...
    match: [/capstone portfolio/, /shipped capstone/, /four live/, /flyrank capstones/],
    next: ["checkpoint", "lens", "broadcast", "muni", "lanes"],
  },
  {
    id: "checkpoint",
    label: "Checkpoint",
    ...
    match: [/checkpoint/],
    next: ["lens", "broadcast", "stack", "capstones"],
  },
  {
    id: "lens",
    label: "Lens",
    ...
    match: [/lens/, /mismatch/],
    next: ["broadcast", "muni", "craft", "capstones"],
  },
  {
    id: "broadcast",
    label: "Broadcast",
    ...
    match: [/broadcast/],
    next: ["muni", "checkpoint", "capstones"],
  },
  {
    id: "muni",
    label: "What is Muni?",
